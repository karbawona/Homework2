...
public class AddMusicActivity extends AppCompatActivity {
    ...
    public void AddNewMusic(View view) {
        ...
        if(taskTitle.isEmpty() && taskArtist.isEmpty() && taskDate.isEmpty()) {
            task = new TaskListContent.Task("task" + TaskListContent.ITEMS.size() + 1, getString(R.string.default_title), getString(R.string.default_artist), getString(R.string.default_date));
            ...
            task = new TaskListContent.Task("task" + TaskListContent.ITEMS.size() + 1, taskTitle, taskArtist, taskDate);
            TaskListContent.addItem(task);
        }
